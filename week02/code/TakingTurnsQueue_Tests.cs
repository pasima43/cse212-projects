...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Enqueue was inserting at the front of the queue instead of the back, causing people to come out in the wrong order.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: GetNextPerson did not re-enqueue a person with 0 or fewer turns (infinite turns), so they were incorrectly removed from the queue. 
